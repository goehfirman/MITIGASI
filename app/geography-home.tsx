...
import BagCatcherGame from '@/components/bag-catcher-game';
...
export default function GeographyHome({section='home'}:{section?:'home'|'belajar'|'mitigasi'|'uji-pemahaman'|'bermain'}){
  ...
  points: [
   {
    ...
    desc: 'Segera merunduk, lindungi kepala di bawah meja kokoh, dan pegang kakinya erat-erat.',
   ...
   },
   {
    ...
    desc: 'Menjauh dari jendela kaca dan benda gantung, serta jangan sekali-kali naik lift.',
   ...
   },
   {
    ...
    desc: 'Jauhi gedung tinggi, tiang listrik, dan pohon besar, lalu segera menuju ke tanah lapang.',
   ...
   },
   {
    ...
    desc: 'Setelah guncangan mereda, segera selamatkan diri ke tempat tinggi untuk mewaspadai tsunami.',
  ...
  points: [
   {
    ...
    desc: 'Keluar gedung dengan tertib lewat tangga darurat menuju titik kumpul yang aman.',
   ...
   },
   {
    ...
    desc: 'Laporkan korban luka kepada petugas atau guru, dan hindari memasuki gedung yang retak.',
   ...
   },
   {
    ...
    desc: 'Tetap berada di area terbuka untuk mengantisipasi bahaya dari gempa susulan.',
   ...
   },
   {
    ...
    desc: 'Pantau informasi resmi dari BMKG atau petugas, dan jangan mudah percaya kabar bohong.',
    badge: 'Pemberitaan Resmi Terverifikasi',
    image: '/mitigasi-setelah-4.png',
